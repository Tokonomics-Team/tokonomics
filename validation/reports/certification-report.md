...
MEMORY
   Baseline RSS              191.79 MB
   Indexed RSS               146.19 MB
   ML RSS                    146.44 MB
   Peak RSS                  146.44 MB
...
| **Lexical Retrieval (BM25)** | 0.23 | 0.06 | 0.14 | 0.16 | 0.28 | 0.08 |
| **Dense Vector Search** | 0.72 | 0.04 | 0.09 | 0.12 | 0.17 | 0.05 |
| **Reranking & MMR Diversity** | 0.37 | 0.05 | 0.08 | 0.09 | 0.13 | 0.05 |
| **Deduplication Suite** | 0.02 | 0.01 | 0.02 | 0.02 | 0.03 | 0.01 |
| **Sufficiency Stopping Rules** | 0.01 | 0 | 0 | 0 | 0.03 | 0 |
| **SDG Program Slicing** | 0.05 | 0.01 | 0.02 | 0.02 | 0.07 | 0.02 |
| **Context Knapsack Solver** | 6.07 | 0.95 | 1.24 | 1.36 | 2.55 | 1 |
| **Semantic Compression** | 0.04 | 0 | 0.01 | 0.01 | 0.01 | 0 |
| **Cache Planner** | 0.02 | 0 | 0 | 0 | 0.01 | 0 |
| **Total Optimization Pipeline** | 0.29 | 0.09 | 0.14 | 0.16 | 0.24 | 0.1 |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| `baseline` | 51.99 | 88.28 | 191.79 | 46.49 | 0 |
| `after_indexing` | 39.05 | 90.73 | 146.19 | 0.15 | 0 |
| `after_embedding_model_load` | 40.14 | 90.95 | 146.44 | 0.15 | 1.5 |
| `after_slm_load` | 40.14 | 90.95 | 146.44 | 0.15 | 2 |
| `peak_compilation` | 40.41 | 90.95 | 146.44 | 0.15 | 2 |
| `after_model_unload` | 40.41 | 90.95 | 146.44 | 0.15 | 0 |

### Scale Stress Growth
| Symbol / Document Count | Graph Nodes | BM25 Documents | Heap Delta (MB) | Process RSS Delta (MB) | Growth Rate (MB / 10k) |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **1,000** | 1,000 | 200 | +1.24 | +0.13 | 12.38 MB |
| **10,000** | 10,000 | 2,000 | +14.12 | +5.31 | 14.12 MB |
| **50,000** | 50,000 | 10,000 | +29.98 | +38.45 | 6 MB |
| **1,00,000** | 1,00,000 | 20,000 | +41.19 | +76.67 | 4.12 MB |
